    ...
    return (
        <div>
            <Head>
                ...
                <meta property="og:image" content="https://hertiages.site/temple-documentation-cover.webp" /> 
                ...
                <meta name="twitter:image" content="https://hertiages.site/temple-documentation-cover.webp" /> 
            ...
            <div className="project-page">
                ...
                {/* HERO */}
                <section className="hero temple-hero-bg" id="project-overview">
                ...
                <div className="container">
                    ...
                    <section className="section">
                        <div className="project-card">
                            <img src="/temple (5).webp" alt="Detailed carving of a temple gopuram" />
                    ...
                    <section className="section">
                        <div className="project-card reverse">
                            <img src="/temple (1).webp" alt="Researcher documenting an old temple inscription" />
                            <div className="project-content">
                    ...
                    <section className="section">
                        <div className="project-card">
                            <img src="/temple (8).webp" alt="Project team meeting with sponsors" />
                            <div className="project-content">
                    ...
                    <section className="section" id="project-details">
                        ...
                        <div className="project-card reverse">
                            <div className="video-placeholder-container">
                                <iframe
                                    src="https://www.youtube.com/embed/FGgyoYx-Q6E?si=OjfkGoEepz8umkSc"
